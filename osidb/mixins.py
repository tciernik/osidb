...
class ACLMixin(models.Model):
    ...
    def _validate_acl_meaningful(self):
        """
        validate that the ACLs are set meaninfully in a way that read ACLs
        contain read groups only and write ACLS only the write ones
        """
